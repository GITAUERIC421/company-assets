...
?>
<div class="modal fade" id="modals-asign-item">
			...
			<div class="modal-body">
				<!-- main form -->
					...
					<div class="form-group" style="display:none">
					    <label class="control-label col-sm-3" for="catID">Category:</label>
					    <div class="col-sm-3"> 
					    	<select name="" class="btn btn-default" id="catID" style="display:none">
					    		<?php 
					    			foreach ($categories as $category) {
					    				# code...
					    			$catID = $category['cat_id'];
				   ...
				   <div class="form-group" >
					 ...
					 <!-- old cat pos -->
					  ...
					  <div class="form-group" style="display:none">
					    <label class="control-label col-sm-3" for="conID">Condition:</label>
					    <div class="col-sm-3"> 
					    	<select name="" class="btn btn-default" id="conID" readonly>
					    		<option value="4">Working</option>
					    	</select>
					    </div>
					  </div>
