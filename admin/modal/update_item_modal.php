...
?>
<div class="modal fade" id="modal-assign-item">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
			...
			<div class="modal-body">
				<!-- main form -->
					<form class="form-horizontal" role="form" id="assign-item-form">
					<input type="hidden" id="iID">
					  <div class="form-group">
					    <label class="control-label col-sm-3" for="itemName-assign">Item Name:</label>
					    <div class="col-sm-9">
					      <input type="text" class="form-control" id="itemName-assign" placeholder="Enter Item Name" autofocus>
					    </div>
					  </div>

					  <div class="form-group">
					    <label class="control-label col-sm-3" for="serialNumber-assign">Serial No.:</label>
					    <div class="col-sm-9"> 
					      <input type="text" class="form-control" id="serialNumber-assign" placeholder="Enter Serial No">
					    </div>
					  </div>

					   <div class="form-group">
					    <label class="control-label col-sm-3" for="modelNumber-assign">Model No.:</label>
					    <div class="col-sm-9"> 
					      <input type="text" class="form-control" id="modelNumber-assign" placeholder="Enter Model No">
					    </div>
					  </div>
					
					  <div class="form-group">
					    <label class="control-label col-sm-3" for="brand-assign">Brand:</label>
					    <div class="col-sm-9"> 
...
<!-- 
					  <div class="form-group">
					    ...
					    <div class="col-sm-9"> 
					      <input type="number" step="any"  class="form-control" id="amount-assign" placeholder="Enter Amount">
					    </div>
					  </div>		

					   <div class="form-group">
					    <label class="control-label col-sm-3" for="purDate-assign">Purchase Date:</label>
					    <div class="col-sm-9"> 
				    ...
				    <div class="form-group">
					    <label class="control-label col-sm-3" for="empID-assign">Employee:</label>
					    <div class="col-sm-9"> 
					    	<select class="btn btn-default" id="empID-assign">
					  ...
					  <div class="form-group">
					    <label class="control-label col-sm-3" for="catID-assign">Category:</label>
					    <div class="col-sm-3"> 
					    	<select name="" class="btn btn-default" id="catID-assign">
					    		<?php 
					    			foreach ($categories as $category) {
					    				# code...
					    			$catID = $category['cat_id'];
					  ...
					  <div class="form-group">
					    <label class="control-label col-sm-3" for="conID-assign">Condition:</label>
					    <div class="col-sm-3"> 
					    	<select name="" class="btn btn-default" id="conID-assign" disabled>
					    		<?php 
					    			foreach ($conditions as $condition) {
					    				# code...
					    				$conID = $condition['con_id'];
